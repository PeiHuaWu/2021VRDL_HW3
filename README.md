...
Please refer to [inference.ipynb](https://github.com/PeiHuaWu/2021VRDL_HW3/blob/main/inference%20.ipynb). You can download the required files in this python code, it's needless to download and upload the files by yourself.
